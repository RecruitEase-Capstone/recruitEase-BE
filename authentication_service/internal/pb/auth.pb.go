...
const file_pb_auth_proto_rawDesc = "" +
	"\n" +
	"\rpb/auth.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x82\x01\n" +
	...
	"\tjwt_token\x18\x01 \x01(\tR\bjwtToken2x\n" +
	"\x15AuthenticationService\x123\n" +
	"\fUserRegister\x12\x10.RegisterRequest\x1a\x11.RegisterResponse\x12*\n" +
	"\tUserLogin\x12\r.LoginRequest\x1a\x0e.LoginResponseB\x06Z\x04./pbb\x06proto3"
...
var file_pb_auth_proto_depIdxs = []int32{
	4, // 0: RegisterResponse.created_at:type_name -> google.protobuf.Timestamp
	4, // 1: RegisterResponse.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: AuthenticationService.UserRegister:input_type -> RegisterRequest
	2, // 3: AuthenticationService.UserLogin:input_type -> LoginRequest
	1, // 4: AuthenticationService.UserRegister:output_type -> RegisterResponse
	3, // 5: AuthenticationService.UserLogin:output_type -> LoginResponse
